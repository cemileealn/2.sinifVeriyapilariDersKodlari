...
public class AVL_Dugum {
    ...
    AVL_Dugum sagaDonus() {
        AVL_Dugum yeniKok = sol;
        AVL_Dugum gecici = yeniKok.sag;
    ...
    AVL_Dugum solaDonus() {
        AVL_Dugum yeniKok = sag;
        AVL_Dugum gecici = yeniKok.sol;
    ...
    AVL_Dugum ekle(AVL_Dugum kok, int yeni) {
        if (kok == null) {
            return new AVL_Dugum(yeni); // Yeni düğüm oluştur
        }
